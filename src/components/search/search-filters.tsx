            ...
            <form onSubmit={handleSearch} className="flex flex-col lg:flex-row gap-2 p-2 bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 shadow-3xl ring-1 ring-white/5">
                ...
                <div className="flex-1 relative group">
                    ...
                    <input
                        ...
                        className="h-14 w-full rounded-2xl bg-transparent pl-24 pr-4 text-base font-medium placeholder:text-white/40 focus:outline-none focus:bg-white/10 transition-all duration-300 hover:bg-white/5 focus:scale-[1.02] text-white relative z-0"
                        value={destination}
